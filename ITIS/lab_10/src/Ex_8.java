...
public class Ex_8 {
    ...
    public static void main(String[] args) {
        try { // С потоком связан файл
            InputStream inFile = new FileInputStream("ex8-file1.txt"); // байтовый поток
            ...
            System.out.print("\n\n\n");
            inFile.close();
            rFile.close(); // С потоком связана интернет-страница передается «русская» кодировка
